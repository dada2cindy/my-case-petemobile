...
namespace WuDada.Core.Post.Service
{
    public interface IPostService
    {
        ...
        /// <param name="sortDesc">升降冪排序</param>
        /// <returns>Post清單</returns>
        IList<PostVO> GetPostListByParentPostId(int parentPostId, bool onlyShow, DateTime? showDate
            , int pageIndex, int pageSize, string sortField, bool sortDesc);
        ...
        /// <param name="sortDesc">升降冪排序</param>
        /// <returns>Post清單</returns>
        IList<PostVO> GetPostListByNodeId(int nodeId, bool onlyShow
            , DateTime? showDate, string sortField, bool sortDesc);
        ...
        /// <returns>Post清單</returns>
        IList<PostVO> GetPostListByParentPostId(int parentPostId, bool onlyShow, DateTime? showDate
            , string sortField, bool sortDesc);
        ...
        /// <param name="postId">PostId</param>
        /// <returns>Post</returns>
        PostVO GetPostByIdNoLazy(int postId);
