...
public partial class admin_UC04_0442 : System.Web.UI.Page
{
    ...
    {
        IList<NodeVO> nodeList = m_PostService.GetNodeListByParentId(21);
        ddlWarrantySuppliers.Items.Clear();
        ddlWarrantySuppliers.Items.Add(new ListItem("請選擇電信公司", ""));
    ...
    {
        return "<img src='../../upload/" + fileName + "' width='340' height='240' border='0'>";
    }
