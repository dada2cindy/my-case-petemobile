...
ORDER BY SortNo "
        ...
        private void InitNode()
        {
            ...
            CreatePost("大4G-469(30)", nodeVO5, 1, 1, nodeVO51.Name, "5800", "4600", "3G 首年吃到飽", "網內前3分免費/網內30分/網外30分/市話10分/熱線一門");
            CreatePost("大4G-579(30)", nodeVO5, 1, 1, nodeVO51.Name, "7700", "6200", "5G 首年吃到飽", "網內前5分免費/網內45分/網外30分/市話20分/熱線二門");
            CreatePost("大4G-799(30)", nodeVO5, 1, 1, nodeVO51.Name, "9800", "8400", "8G 首年吃到飽", "網內前7分免費/網內60分/網外40分/市話35分/熱線三門");
            ...
            CreatePost("799(30)學生", nodeVO5, 1, 1, nodeVO52.Name, "10500", "5000", "7G 首年吃到飽", "網內前10分免費/網外送40分");
            CreatePost("399(30)", nodeVO5, 1, 1, nodeVO52.Name, "5800", "2400", "2G", "網內前3分免費/網外送20分");
            CreatePost("599(30)", nodeVO5, 1, 1, nodeVO52.Name, "8000", "5000", "6G 首年吃到飽", "網內前5分免費/網外送30分");
            CreatePost("799(30)", nodeVO5, 1, 1, nodeVO52.Name, "11000", "6000", "9G 首年吃到飽", "網內前10分免費/網外送40分");
            CreatePost("999(30)", nodeVO5, 1, 1, nodeVO52.Name, "13000", "8000", "16G 首年吃到飽", "網內前10分免費/網外送50分");
            ...
            CreatePost("599月租半價299(30)", nodeVO5, 1, 1, nodeVO53.Name, "4500", "1000", "1G", "網內前5分免費/網外送30分");
            CreatePost("399(30)", nodeVO5, 1, 1, nodeVO53.Name, "6000", "1000", "3G 前3月吃到飽", "網內前3分免費/網外送20分");
            CreatePost("599(30)", nodeVO5, 1, 1, nodeVO53.Name, "8000", "4193", "6G 首年吃到飽", "網內前5分免費/網外送30分");
            CreatePost("799(30)", nodeVO5, 1, 1, nodeVO53.Name, "11000", "5593", "9G 首年吃到飽", "網內前10分免費/網外送40分");
            CreatePost("999(30)", nodeVO5, 1, 1, nodeVO53.Name, "12000", "7000", "16G 前15月吃到飽", "網內前10分免費/網外送50分");
            ...
            CreatePost("688(30)", nodeVO5, 1, 1, nodeVO54.Name, "9000", "6000", "吃到飽", "網內免費/網外送45分");
            CreatePost("399(30)", nodeVO5, 1, 1, nodeVO54.Name, "4500", "2700", "1G", "網內前5分免費/網外送20分");
            CreatePost("599(12)", nodeVO5, 1, 1, nodeVO54.Name, "1000", "600", "吃到飽", "網內免費/網外送30分");
            CreatePost("599(30)", nodeVO5, 1, 1, nodeVO54.Name, "8000", "6000", "5G", "網內免費/網外送30分");
            CreatePost("599(30)U25", nodeVO5, 1, 1, nodeVO54.Name, "8000", "6000", "吃到飽", "網內免費/網外送30分");
            CreatePost("699(30)U25", nodeVO5, 1, 1, nodeVO54.Name, "8500", "6000", "吃到飽", "網內免費/網外送30分");
            CreatePost("799(30)", nodeVO5, 1, 1, nodeVO54.Name, "11000", "7000", "吃到飽", "網內免費/網外送45分");
            CreatePost("899(30)", nodeVO5, 1, 1, nodeVO54.Name, "12000", "7000", "吃到飽", "網內免費/網外送45分");
            CreatePost("999(30)", nodeVO5, 1, 1, nodeVO54.Name, "15000", "9000", "吃到飽", "網內免費/網外送80分");
            CreatePost("1099(30)", nodeVO5, 1, 1, nodeVO54.Name, "15000", "10000", "吃到飽", "網內免費/網外送80分");
            CreatePost("1199(30)", nodeVO5, 1, 1, nodeVO54.Name, "17000", "14000", "吃到飽", "網內免費/網外送100分");
            CreatePost("1299(30)", nodeVO5, 1, 1, nodeVO54.Name, "17000", "14000", "吃到飽", "網內免費/網外送100分");
            ...
            CreatePost("1299(30)", nodeVO5, 1, 1, nodeVO55.Name, "17500", "12900", "吃到飽", "不分網內外前6分免費");
            CreatePost("498(30)", nodeVO5, 1, 1, nodeVO55.Name, "7500", "0", "5G", "網內免費/網外+市話送40分");
            CreatePost("698(30)", nodeVO5, 1, 1, nodeVO55.Name, "10800", "0", "7G", "網內免費/網外+市話送50分");
            CreatePost("750(30)", nodeVO5, 1, 1, nodeVO55.Name, "9500", "5700", "吃到飽", "網內免費/網外+市話送58分");
            CreatePost("898(30)", nodeVO5, 1, 1, nodeVO55.Name, "13500", "7400", "吃到飽", "網內免費/網外+市話送80分");            
            CreatePost("1398(30)", nodeVO5, 1, 1, nodeVO55.Name, "20000", "12900", "吃到飽", "網內免費/網外+市話送120分");
        }
