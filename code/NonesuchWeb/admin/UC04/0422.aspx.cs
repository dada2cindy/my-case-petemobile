...
public partial class admin_UC04_0422 : System.Web.UI.Page
{
    ...
    private void initSelect()
    {
        ...
        ddlSelect.Items.Add(new ListItem("請選擇分類", ""));
    ...
    private void fillGridView()
    {
        ...
        {
            int subNodeId = int.Parse(ddlSelect.SelectedValue);
            ...
            //分頁
            AspNetPager1.RecordCount = m_PostService.CountPostListByNodeId(subNodeId, false, startDate);
            int pageIndex = (AspNetPager1.CurrentPageIndex - 1);
            int pageSize = AspNetPager1.PageSize;

            gvList.DataSource = m_PostService.GetPostListByNodeId(subNodeId, false, startDate, pageIndex, pageSize, sortField, sortDesc);
            gvList.DataBind();
        }
        else
        {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(ddlSelect.SelectedValue))
        {
            ...
            postVO.Node = m_PostService.GetNodeById(subNodeId);
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowIndex != -1)
        {
            ...
            UIHelper.SetLabelText(ref ctrl, "lblNodeName", node.Name);
