<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdmMasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="0422.aspx.cs" Inherits="admin_UC04_0422" %>
            ...
            <table style="width: 100%" class="FormTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="請輸入標題"
    ...
    <asp:Panel ID="pnlGv" runat="server">
        <fieldset class="fieldset">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnShowAdd" runat="server" Text="新增文章" OnClick="btnShowAdd_Click" Enabled="false"/>
                    </td>
            ...
            <asp:GridView ID="gvList" runat="server" BackColor="White" BorderColor="#DEDFDE"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="文章分類">
                        <ItemTemplate>
