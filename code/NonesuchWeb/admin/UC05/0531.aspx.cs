...
public partial class admin_UC05_0531 : System.Web.UI.Page
{
    ...
    private string m_PicFileName2
    {
        get { if (ViewState["picfilename2"] == null) { ViewState["picfilename2"] = string.Empty; } return ViewState["picfilename2"].ToString(); }
        set { ViewState["picfilename2"] = value; }
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        postVO.PicFileName2 = m_PicFileName2;
    ...
    private void ClearUI()
    {
        ...
        m_PicFileName2 = string.Empty;
        //ltlImg2.Text = string.Empty;
    ...
    protected void gvList_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (cmdName)
        {
            case "myModify":
                ...
                m_PicFileName2 = postVO.PicFileName2;
                //ltlImg2.Text = GetPic(m_PicFileName2);
    ...
    //protected void btnUpliad2_Click(object sender, EventArgs e)
    //{
    //    try
    //    {
    //        HttpFileCollection hfc = Request.Files;
    ...
    //                    string fileName = DateTime.Now.ToString("yyyyMMddHHmmss") + System.IO.Path.GetFileName(hpf.FileName);
    //                    hpf.SaveAs(Server.MapPath("~\\") + "\\upload\\" + fileName);
    //                    ltlImg2.Text = GetPic(fileName);
    //                    m_PicFileName2 = fileName;
    //                }
    //                else
    //                {
    //                    ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "js", JavascriptUtil.AlertJS("請點選您要上傳的照片!"), false);
