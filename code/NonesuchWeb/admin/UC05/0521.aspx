            ...
            <table style="width: 100%" class="FormTable">                
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="請輸入醫師姓名"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCustomField1" runat="server" Width="200px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="請輸入學歷"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCustomField2" runat="server" Width="700px"></asp:TextBox><br />
                        <%--<asp:Label ID="Label1" runat="server" Text="每個項目請使用 , 分隔" ForeColor="Red"></asp:Label>--%>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="請輸入主治項目"
                ...
                <%--<tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="請選擇是否顯示於超強醫師群"
                            ControlToValidate="ddlFlag"></asp:RequiredFieldValidator>
                    </td>
                </tr>--%>
                <tr>
    ...
    <asp:Panel ID="pnlGv" runat="server">
        <fieldset class="fieldset">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnShowAdd" runat="server" Text="新增醫師" OnClick="btnShowAdd_Click" />
                    </td>
            ...
            <asp:GridView ID="gvList" runat="server" BackColor="White" BorderColor="#DEDFDE"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="醫師姓名">
                        <ItemTemplate>
