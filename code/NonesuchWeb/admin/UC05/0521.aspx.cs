...
public partial class admin_UC05_0521 : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        postVO.HtmlContent = txtContent.Text.Trim();
        postVO.PicFileName = m_PicFileName;
        postVO.Flag = int.Parse(ddlFlag.SelectedValue);
        postVO.CustomField1 = txtCustomField1.Text.Trim();
        postVO.CustomField2 = txtCustomField2.Text.Trim();
        //postVO.IsRecommend = bool.Parse(ddlIsRecommend.SelectedValue);
    ...
    private void ClearUI()
    {
        ...
        //ddlIsRecommend.SelectedValue = string.Empty;
    ...
    protected void gvList_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (cmdName)
        {
            case "myModify":
                ...
                txtContent.Text = postVO.HtmlContent;
                ddlFlag.SelectedValue = postVO.Flag.ToString();
                txtCustomField1.Text = postVO.CustomField1;
                txtCustomField2.Text = postVO.CustomField2;
                //ddlIsRecommend.SelectedValue = postVO.IsRecommend.ToString();
