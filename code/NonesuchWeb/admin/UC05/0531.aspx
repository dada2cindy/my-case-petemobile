<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdmMasterPage.master" AutoEventWireup="true" CodeFile="0531.aspx.cs" Inherits="admin_UC05_0531" ValidateRequest="false" %>
                ...
                <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>
                                    <asp:FileUpload ID="FileUpload2" runat="server" accept="png|jpg" class="multi" maxlength="1"
                                        CssClass="order02" />
                                </td>
                                <td>
                                    <asp:Button ID="btnUpliad2" runat="server" Text="確定上傳" OnClick="btnUpliad2_Click" CssClass="order02" CausesValidation="false" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Literal ID="ltlImg2" runat="server"></asp:Literal>
                                </td>
                            </tr>
                        </table>
                    </td>
