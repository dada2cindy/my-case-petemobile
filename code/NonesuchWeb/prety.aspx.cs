...
public partial class prety : System.Web.UI.Page
{
    private PostFactory m_PostFactory;
    private IPostService m_PostService;

    //美麗見證分類 m_ParentNodeId=10
    private int m_ParentNodeId = 10;

    //美麗見證子分類 NodeId=0
    private int m_NodeId = 0;

    private string m_ListPath = "prety.aspx";
    ...
    protected void RepeaterPrety_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
