<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="news2.aspx.cs" Inherits="news2" %>
      ...
      <div id="AllInOB">
        <div id="AllTitle">
          ...
          <asp:Repeater ID="RepeaterNews" runat="server" onitemdatabound="RepeaterNews_ItemDataBound">
                    <ItemTemplate>
                        <div class="HotNews2_Table">
          <p><a href="news_in.aspx?id=<%# Eval("PostId") %>"><img src="image/more_2.png" width="62" height="62"></a></p>
          <a href="news_in.aspx?id=<%# Eval("PostId") %>"><img src="upload/<%# Eval("PicFileName")%>" width="200" height="136"></a>
